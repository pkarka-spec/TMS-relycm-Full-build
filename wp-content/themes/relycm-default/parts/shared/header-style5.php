	...
	<div class="top-line d-none d-lg-block sh-sticky-wrap">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 d-none d-lg-flex ustify-content-left align-items-center align-items-lg-end col-sm-12 col-12">
					<?php
			        $tel_number = get_field('global_phone_number','option');
			        $unformatted_tel_number = preg_replace("/[^0-9]/", '', $tel_number);?>
			        <?php if ($tel_number): ?>
			              <span class="sh-ph"><a class="cms_phone" href="tel:<?php echo $unformatted_tel_number;?>" aria-label="Call Us" title="Call Us"><i class="fa fa-phone" aria-hidden="true"></i> <span><strong>Call:</strong> <?php echo $tel_number;?></span></a></span>
			        <?php endif ?>
					 <?php
				...
				<div class="col-lg-4 text-right d-none d-lg-flex justify-content-end align-items-center">
			        <?php 
		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				...
				<?php } else { ?>
					...
					<?php
	                if( !empty($logo) ): ?>
	                    <a href="<?php echo bloginfo('url') . '/home'; ?>" class="site-logo"><img src="<?php echo $logo['url']; ?>" alt="<?php echo $logo['alt']; ?>" title="<?php echo $logo['alt']; ?>"></a>
	                <?php else: 
	                	the_custom_logo();
	                 endif;?>
	                </div>
				...
				<div class="utility-nav navbar-right d-lg-none">
					...
					if( $link ): 
					    ...
					    $link_target = $link['target'] ? $link['target'] : '_self';
					    ?>
					    <a class="button btn btn-primary d-lg-none px-4 m-0  tl-btn" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">RFQ</a>
					<?php endif; ?>
				</div>
